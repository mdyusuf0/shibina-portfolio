...
const Hero = () => {
  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden bg-[#FBFBFD] pt-[46px]">
      ...
      {/* Background Video — Plays ONLY on manual click with sound */}
      ...
      <div className="absolute top-[60px] md:top-[76px] left-6 md:left-12 lg:left-20 z-20 flex flex-col items-start text-left max-w-lg lg:max-w-xl">
        ...
        <span 
          data-aos="fade-up"
          className="font-cursive text-2xl md:text-3xl text-purple-600 font-bold mb-1 drop-shadow-xs"
        >
